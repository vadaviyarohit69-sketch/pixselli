...
const PNG_COMPRESSOR_COPY = {
  en: {
    invalidFile: 'Please select a valid image file',
    schemaWebAppName: 'PNG Compressor - Free Online Image Compression Tool',
    schemaWebAppDescription:
      'Free online PNG Compressor to reduce image file size without losing quality. Compress JPG, PNG, WebP images with adjustable quality settings.',
    schemaFeatureList: [
      'Compress JPG images',
      'Compress PNG images',
    ...
    schemaHowToTool: 'Pixselli PNG Compressor',
    ...
    statsSaved: 'Saved',
    aboutTitle: 'About PNG Compressor',
    aboutP1:
      'Our free online PNG Compressor helps you reduce image file size without compromising visual quality. Perfect for optimizing images for websites, social media, email attachments, and cloud storage. Compress JPG, PNG, and WebP images with adjustable quality settings from 10% to 100%.',
    aboutP2:
  ...
  es: {
    ...
    schemaWebAppName: 'Compresor PNG - Herramienta Gratis de Compresion de Imagenes',
    schemaWebAppDescription:
      'Compresor PNG gratis para reducir el tamano de imagen sin perder calidad. Comprime JPG, PNG y WebP con control de calidad ajustable.',
    schemaFeatureList: [
    ...
    schemaHowToTool: 'Pixselli Compresor PNG',
    ...
    statsSaved: 'Ahorro',
    aboutTitle: 'Acerca del Compresor PNG',
    aboutP1:
      'Nuestro Compresor PNG gratis reduce el tamano del archivo sin comprometer la calidad. Ideal para web, redes sociales, correo y almacenamiento. Comprime JPG, PNG y WebP con calidad ajustable de 10% a 100%.',
    aboutP2:
  ...
  pt: {
    ...
    schemaWebAppName: 'Compressor PNG - Ferramenta Gratis de Compressao',
    schemaWebAppDescription:
      'Compressor PNG gratis para reduzir o tamanho da imagem sem perder qualidade. Comprima JPG, PNG e WebP com controle de qualidade.',
    schemaFeatureList: [
    ...
    schemaHowToTool: 'Pixselli Compressor PNG',
    ...
    breadcrumbHome: 'Inicio',
    breadcrumbTool: 'Compressor PNG',
    title: 'Compressor PNG',
    subtitle:
    ...
    statsCompressed: 'Comprimida',
    statsSaved: 'Economia',
    aboutTitle: 'Sobre o Compressor PNG',
    aboutP1:
      'Nosso Compressor PNG gratis reduz o tamanho do arquivo sem comprometer a qualidade. Ideal para web, redes sociais, email e armazenamento. Comprima JPG, PNG e WebP com qualidade ajustavel de 10% a 100%.',
    aboutP2:
  ...
  fr: {
    ...
    schemaWebAppName: 'Compresseur PNG - Outil Gratuit de Compression',
    schemaWebAppDescription:
      'Compresseur PNG gratuit pour reduire la taille des images sans perdre de qualite. Compressez JPG, PNG et WebP avec un reglage de qualite.',
    schemaFeatureList: [
    ...
    schemaHowToTool: 'Pixselli Compresseur PNG',
    ...
    breadcrumbTool: 'Compresseur PNG',
    ...
    statsSaved: 'Economie',
    aboutTitle: 'A propos du Compresseur PNG',
    aboutP1:
      'Notre compresseur PNG gratuit reduit la taille des images sans compromettre la qualite. Ideal pour le web, les reseaux sociaux, les emails et le stockage. Compressez JPG, PNG et WebP avec un reglage de 10% a 100%.',
    aboutP2:
  ...
  de: {
    ...
    schemaWebAppName: 'PNG Kompressor - Kostenloses Online Tool',
    schemaWebAppDescription:
      'Kostenloser PNG Kompressor zum Reduzieren der Bilddateigrosse ohne sichtbaren Qualitatsverlust. Komprimiert JPG, PNG und WebP mit Qualitatsregler.',
    schemaFeatureList: [
    ...
    schemaHowToTool: 'Pixselli PNG Kompressor',
    ...
    breadcrumbTool: 'PNG Kompressor',
    title: 'PNG Kompressor',
    subtitle:
    ...
    aboutTitle: 'Uber den PNG Kompressor',
    aboutP1:
      'Unser kostenloser PNG Kompressor reduziert die Dateigrosse ohne die visuelle Qualitat stark zu beeintrachtigen. Ideal fur Websites, Social Media, E-Mails und Cloud. Komprimiert JPG, PNG und WebP von 10% bis 100%.',
    aboutP2:
  ...
  it: {
    ...
    schemaWebAppName: 'Compressore PNG - Strumento Online Gratis',
    schemaWebAppDescription:
      'Compressore PNG gratis per ridurre la dimensione delle immagini senza perdere qualita. Comprimi JPG, PNG e WebP con controllo qualita.',
    schemaFeatureList: [
    ...
    schemaHowToTool: 'Pixselli Compressore PNG',
    ...
    breadcrumbHome: 'Home',
    breadcrumbTool: 'Compressore PNG',
    ...
    aboutTitle: 'Informazioni sul Compressore PNG',
    aboutP1:
      'Il nostro compressore PNG gratis riduce la dimensione del file senza compromettere la qualita. Ideale per web, social, email e cloud. Comprimi JPG, PNG e WebP con qualita da 10% a 100%.',
    aboutP2:
...
export default function Page() {
  ...
  const copy = PNG_COMPRESSOR_COPY[locale as keyof typeof PNG_COMPRESSOR_COPY] ?? PNG_COMPRESSOR_COPY.en;
  const homeHref = locale === 'en' ? '/' : `/${locale}`;
  const toolPath = locale === 'en' ? '/png-compressor' : `/${locale}/png-compressor`;
