...
const JPG_COMPRESSOR_COPY = {
  en: {
    invalidFile: 'Please select a valid image file',
    schemaWebAppName: 'JPG Compressor - Free Online Image Compression Tool',
    schemaWebAppDescription:
      'Free online JPG Compressor to reduce image file size without losing quality. Compress JPG, PNG, WebP images with adjustable quality settings.',
    schemaFeatureList: [
      'Compress JPG images',
      'Compress PNG images',
    ...
    schemaHowToTool: 'Pixselli JPG Compressor',
    ...
    statsSaved: 'Saved',
    aboutTitle: 'About JPG Compressor',
    aboutP1:
      'Our free online JPG Compressor helps you reduce image file size without compromising visual quality. Perfect for optimizing images for websites, social media, email attachments, and cloud storage. Compress JPG, PNG, and WebP images with adjustable quality settings from 10% to 100%.',
    aboutP2:
  ...
  es: {
    ...
    schemaWebAppName: 'Compresor JPG - Herramienta Gratis de Compresion de Imagenes',
    schemaWebAppDescription:
      'Compresor JPG gratis para reducir el tamano de imagen sin perder calidad. Comprime JPG, PNG y WebP con control de calidad ajustable.',
    schemaFeatureList: [
    ...
    schemaHowToTool: 'Pixselli Compresor JPG',
    ...
    statsSaved: 'Ahorro',
    aboutTitle: 'Acerca del Compresor JPG',
    aboutP1:
      'Nuestro Compresor JPG gratis reduce el tamano del archivo sin comprometer la calidad. Ideal para web, redes sociales, correo y almacenamiento. Comprime JPG, PNG y WebP con calidad ajustable de 10% a 100%.',
    aboutP2:
  ...
  pt: {
    ...
    schemaWebAppName: 'Compressor JPG - Ferramenta Gratis de Compressao',
    schemaWebAppDescription:
      'Compressor JPG gratis para reduzir o tamanho da imagem sem perder qualidade. Comprima JPG, PNG e WebP com controle de qualidade.',
    schemaFeatureList: [
    ...
    schemaHowToTool: 'Pixselli Compressor JPG',
    ...
    breadcrumbHome: 'Inicio',
    breadcrumbTool: 'Compressor JPG',
    title: 'Compressor JPG',
    subtitle:
    ...
    statsCompressed: 'Comprimida',
    statsSaved: 'Economia',
    aboutTitle: 'Sobre o Compressor JPG',
    aboutP1:
      'Nosso Compressor JPG gratis reduz o tamanho do arquivo sem comprometer a qualidade. Ideal para web, redes sociais, email e armazenamento. Comprima JPG, PNG e WebP com qualidade ajustavel de 10% a 100%.',
    aboutP2:
  ...
  fr: {
    ...
    schemaWebAppName: 'Compresseur JPG - Outil Gratuit de Compression',
    schemaWebAppDescription:
      'Compresseur JPG gratuit pour reduire la taille des images sans perdre de qualite. Compressez JPG, PNG et WebP avec un reglage de qualite.',
    schemaFeatureList: [
    ...
    schemaHowToTool: 'Pixselli Compresseur JPG',
    ...
    breadcrumbTool: 'Compresseur JPG',
    title: 'Compresseur JPG',
    subtitle:
    ...
    statsSaved: 'Economie',
    aboutTitle: 'A propos du Compresseur JPG',
    aboutP1:
      'Notre compresseur JPG gratuit reduit la taille des images sans compromettre la qualite. Ideal pour le web, les reseaux sociaux, les emails et le stockage. Compressez JPG, PNG et WebP avec un reglage de 10% a 100%.',
    aboutP2:
  ...
  de: {
    ...
    schemaWebAppName: 'JPG Kompressor - Kostenloses Online Tool',
    schemaWebAppDescription:
      'Kostenloser JPG Kompressor zum Reduzieren der Bilddateigrosse ohne sichtbaren Qualitatsverlust. Komprimiert JPG, PNG und WebP mit Qualitatsregler.',
    schemaFeatureList: [
    ...
    schemaHowToTool: 'Pixselli JPG Kompressor',
    ...
    breadcrumbTool: 'JPG Kompressor',
    title: 'JPG Kompressor',
    subtitle:
    ...
    aboutTitle: 'Uber den JPG Kompressor',
    aboutP1:
      'Unser kostenloser JPG Kompressor reduziert die Dateigrosse ohne die visuelle Qualitat stark zu beeintrachtigen. Ideal fur Websites, Social Media, E-Mails und Cloud. Komprimiert JPG, PNG und WebP von 10% bis 100%.',
    aboutP2:
  ...
  it: {
    ...
    schemaWebAppName: 'Compressore JPG - Strumento Online Gratis',
    schemaWebAppDescription:
      'Compressore JPG gratis per ridurre la dimensione delle immagini senza perdere qualita. Comprimi JPG, PNG e WebP con controllo qualita.',
    schemaFeatureList: [
    ...
    schemaHowToTool: 'Pixselli Compressore JPG',
    ...
    breadcrumbHome: 'Home',
    breadcrumbTool: 'Compressore JPG',
    title: 'Compressore JPG',
    subtitle:
    ...
    aboutTitle: 'Informazioni sul Compressore JPG',
    aboutP1:
      'Il nostro compressore JPG gratis riduce la dimensione del file senza compromettere la qualita. Ideale per web, social, email e cloud. Comprimi JPG, PNG e WebP con qualita da 10% a 100%.',
    aboutP2:
...
export default function Page() {
  ...
  const copy = JPG_COMPRESSOR_COPY[locale as keyof typeof JPG_COMPRESSOR_COPY] ?? JPG_COMPRESSOR_COPY.en;
  const homeHref = locale === 'en' ? '/' : `/${locale}`;
  const toolPath = locale === 'en' ? '/jpg-compressor' : `/${locale}/jpg-compressor`;
