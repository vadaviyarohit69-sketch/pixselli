...
import { COMPRESS_FOR_WHATSAPP_TEXT_BY_LOCALE } from '@/lib/compressForWhatsappTranslations';
...
export default function Page() {
  ...
  const dict = COMPRESS_FOR_WHATSAPP_TEXT_BY_LOCALE[locale] ?? {};
  ...
  const processImageToTargetSize = useCallback(async (
    ...
    try {
      ...
      // Calculate WhatsApp-Ready dimensions
      let width = img.width;
  ...
  const downloadImage = async () => {
    ...
    if (outputVariants.length === 1) {
      ...
      link.download = normalizeDownloadName(`whatsapp_ready_image.${single.extension}`);
    ...
    outputVariants.forEach((variant) => {
      zip.file(`whatsapp_ready_${variant.label.toLowerCase()}.${variant.extension}`, variant.blob);
    });
    ...
    const link = document.createElement('a');
    link.href = zipUrl;
    link.download = normalizeDownloadName(`whatsapp_ready_outputs.zip`);
    document.body.appendChild(link);
    link.click();
    document.body.removeChild(link);
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "WebApplication",
            "name": "Compress for WhatsApp - Image Optimizer",
            "description": "Optimize images for WhatsApp sharing with automatic resizing to 1280x1280 and 80% quality compression.",
        ...
        <main className="max-w-7xl mx-auto">
          ...
          <nav aria-label="Breadcrumb" className="mb-8">
            <ol className="flex items-center gap-2 text-sm text-gray-600" itemScope itemType="https://schema.org/BreadcrumbList">
              ...
              <li itemProp="itemListElement" itemScope itemType="https://schema.org/ListItem">
                <span itemProp="name" className="text-gray-900 font-medium">Compress for WhatsApp</span>
          ...
          <header className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Optimize images for fast WhatsApp sharing with automatic resizing and compression. Fast, secure, and works entirely in your browser.
            </p>
          </header>
          ...
          <div className="bg-gradient-to-r from-purple-50 to-pink-50 border border-purple-200 rounded-xl p-6 mb-8 max-w-4xl mx-auto">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-gray-900 mb-2">WhatsApp-Ready Settings</h3>
                <p className="text-sm text-gray-700">
                  Automatically resizes to WhatsApp-friendly dimensions (max 1280×1280) and applies 80% quality compression - the perfect balance for fast WhatsApp sharing while maintaining excellent visual quality.
                </p>
              </div>
            </div>
          </div>
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-2xl font-bold text-gray-800 mb-3">
                    Upload Image to Optimize for WhatsApp
                  </p>
              ...
              <div className="space-y-6">
                ...
                {imageState.compressedSize > 0 && (
                  <div className="grid grid-cols-3 gap-4">
                    ...
                    <div className="bg-gradient-to-br from-green-50 to-green-100 border-green-200 rounded-lg p-4 border text-center">
                      <p className="text-xs font-medium mb-1 text-green-600">WhatsApp-Ready</p>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="text-sm font-medium mb-1 text-green-900">
                          ✓ WhatsApp-Ready Successfully!
                        </p>
                        <p className="text-xs text-green-700">
                          Compressed to {formatFileSize(imageState.compressedSize)} with 80% quality. Perfect for fast WhatsApp sharing while maintaining excellent visual quality.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="flex gap-3">
                  ...
                  >
                    ...
                    {outputVariants.length > 1 ? 'Download WhatsApp-Ready Outputs (ZIP)' : 'Download WhatsApp-Ready Image'}
                  </button>
                </div>
              </div>
            )}
          ...
          <section className="bg-white rounded-xl shadow-md p-8 border border-gray-200 mb-12 max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">About Compress for WhatsApp Tool</h2>
            <div className="space-y-4 text-gray-700 leading-relaxed">
              <p>
                Our free online tool optimizes images for WhatsApp sharing. It automatically resizes large images to WhatsApp-friendly dimensions (max 1280×1280) and applies 80% quality compression - the sweet spot for balancing file size and visual quality for WhatsApp.
              </p>
              <p>
                Perfect for WhatsApp users who want smaller images that still look great. All processing happens securely in your browser. No registration required, completely free to use.
              </p>
            </div>
          </section>

          {/* Why WhatsApp Optimization Matters Section */}
          <section className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl shadow-md p-8 border border-purple-200 mb-12 max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">Why WhatsApp Image Optimization Matters</h2>
            
            <div className="grid md:grid-cols-2 gap-6 mb-6">
              <div className="bg-white p-5 rounded-xl">
                <h3 className="font-bold text-purple-700 mb-3">🚀 Faster Sending</h3>
                <p className="text-gray-600 text-sm leading-relaxed">
                  Smaller images send faster in chats and upload more quickly, especially on mobile connections.
                </p>
              </div>
              
              <div className="bg-white p-5 rounded-xl">
                <h3 className="font-bold text-purple-700 mb-3">📶 Lower Data Usage</h3>
                <p className="text-gray-600 text-sm leading-relaxed">
                  Compressed images use less data when you send them, and they download faster for recipients.
                </p>
              </div>

              <div className="bg-white p-5 rounded-xl">
                <h3 className="font-bold text-purple-700 mb-3">💾 Save Storage</h3>
                <p className="text-gray-600 text-sm leading-relaxed">
                  Smaller image files take up less storage on your phone and are easier to manage.
                </p>
              </div>

              <div className="bg-white p-5 rounded-xl">
                <h3 className="font-bold text-purple-700 mb-3">✅ Share-Friendly Quality</h3>
                <p className="text-gray-600 text-sm leading-relaxed">
                  This tool keeps good visual quality while reducing file size so images look great when shared.
                </p>
              </div>
            </div>
              ...
              <table className="w-full text-sm bg-white rounded-lg overflow-hidden">
                ...
                <tbody className="divide-y divide-gray-100">
                  <tr>
                    ...
                    <td className="py-3 px-4 text-green-600">200-800 KB</td>
                  </tr>
                  <tr className="bg-gray-50">
                    <td className="py-3 px-4 font-medium">Send / Upload Time</td>
                    <td className="py-3 px-4 text-red-600">10-30 seconds</td>
                    <td className="py-3 px-4 text-green-600">2-8 seconds</td>
                  </tr>
                  <tr>
                    <td className="py-3 px-4 font-medium">Data Usage</td>
                    <td className="py-3 px-4 text-red-600">Higher</td>
                    <td className="py-3 px-4 text-green-600">Lower</td>
                  </tr>
                  <tr className="bg-gray-50">
                    <td className="py-3 px-4 font-medium">Sharing Reliability</td>
          ...
          <section className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12 max-w-4xl mx-auto">
            <div className="bg-white rounded-xl shadow-md p-6 text-center border border-gray-200 hover:border-purple-400 hover:shadow-lg transition-all">
              ...
              <h3 className="text-lg font-bold text-gray-900 mb-2">WhatsApp-Ready</h3>
              <p className="text-gray-600">Perfect balance for fast WhatsApp sharing.</p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-md p-6 text-center border border-gray-200 hover:border-pink-400 hover:shadow-lg transition-all">
              ...
              <p className="text-gray-600">Auto-resize to 1280×1280 max dimensions.</p>
            </div>
          ...
          {/* How to Use Section */}
          <section className="bg-white rounded-xl shadow-md p-8 border border-gray-200 mb-12 max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">How to Optimize Images for WhatsApp</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Smart resize to 1280×1280 max and 80% quality compression.</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Check file size reduction and quality for your WhatsApp needs.</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Download your WhatsApp-Ready image ready for your WhatsApp.</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-6 p-4 bg-purple-50 border border-purple-200 rounded-lg">
              <p className="text-sm text-purple-800">
                <strong>Pro Tip:</strong> This tool is perfect for chat images, status updates, and general WhatsApp sharing. The 80% quality provides excellent visuals while keeping file sizes smaller.
              </p>
            </div>
          </section>
          ...
          <section className="max-w-4xl mx-auto mb-12">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white rounded-xl shadow-md border border-gray-200 overflow-hidden">
                ...
                {openFaqIndex === 0 && (
                  <div className="px-6 pb-4 pt-2 text-gray-700 border-t border-gray-100">
                    <p>This tool is specifically optimized for WhatsApp sharing. It automatically resizes oversized images to WhatsApp-friendly dimensions (max 1280×1280) and applies 80% quality compression - the sweet spot for balancing file size and visual quality for WhatsApp.</p>
                  </div>
                )}
              </div>
              ...
              <div className="bg-white rounded-xl shadow-md border border-gray-200 overflow-hidden">
                ...
                {openFaqIndex === 1 && (
                  <div className="px-6 pb-4 pt-2 text-gray-700 border-t border-gray-100">
                    <p>80% quality is a great balance for sharing. It provides significant file size reduction while maintaining excellent visual quality that's virtually indistinguishable from the original to most people. This helps images send faster without sacrificing appearance.</p>
                  </div>
                )}
              </div>
              ...
              <div className="bg-white rounded-xl shadow-md border border-gray-200 overflow-hidden">
                ...
                {openFaqIndex === 2 && (
                  <div className="px-6 pb-4 pt-2 text-gray-700 border-t border-gray-100">
                    <p>Only if necessary. Images larger than 1280×1280 pixels will be resized to fit within these dimensions while maintaining the original aspect ratio. Smaller images keep their original dimensions. This prevents unnecessarily large images from taking longer to send.</p>
                  </div>
                )}
              </div>
