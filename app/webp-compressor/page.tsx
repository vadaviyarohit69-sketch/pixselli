...
const WEBP_COMPRESSOR_COPY = {
  en: {
    invalidFile: 'Please select a valid image file',
    schemaWebAppName: 'WebP Compressor - Free Online Image Compression Tool',
    schemaWebAppDescription:
      'Free online WebP Compressor to reduce image file size without losing quality. Compress JPG, PNG, WebP images with adjustable quality settings.',
    schemaFeatureList: [
      'Compress JPG images',
      'Compress PNG images',
    ...
    schemaHowToTool: 'Pixselli WebP Compressor',
    ...
    breadcrumbHome: 'Home',
    breadcrumbTool: 'WebP Compressor',
    title: 'WebP Compressor',
    subtitle:
      'Compress images without losing quality. Reduce file size of JPG, PNG, and WebP images with adjustable quality settings. Perfect for web optimization, email attachments, and faster loading times. Fast, secure, and works entirely in your browser.',
    ...
    statsSaved: 'Saved',
    aboutTitle: 'About WebP Compressor',
    aboutP1:
      'Our free online WebP Compressor helps you reduce image file size without compromising visual quality. Perfect for optimizing images for websites, social media, email attachments, and cloud storage. Compress JPG, PNG, and WebP images with adjustable quality settings from 10% to 100%.',
    aboutP2:
  ...
  es: {
    ...
    schemaWebAppName: 'Compresor WebP - Herramienta Gratis de Compresion de Imagenes',
    schemaWebAppDescription:
      'Compresor WebP gratis para reducir el tamano de imagen sin perder calidad. Comprime JPG, PNG y WebP con control de calidad ajustable.',
    schemaFeatureList: [
      'Comprimir imagenes JPG',
    ...
    schemaHowToTool: 'Pixselli Compresor WebP',
    ...
    schemaFaq1A:
      'La compresion reduce el tamano del archivo eliminando datos redundantes manteniendo la calidad visual. Nuestra herramienta optimiza JPG, PNG y WebP sin perdida notable.',
    ...
    breadcrumbTool: 'Compresor WebP',
    title: 'Compresor WebP',
    subtitle:
      'Comprime imagenes sin perder calidad. Reduce el tamano de JPG, PNG y WebP con control de calidad. Rapido, seguro y funciona totalmente en tu navegador.',
    ...
    statsSaved: 'Ahorro',
    aboutTitle: 'Acerca del Compresor WebP',
    aboutP1:
      'Nuestro Compresor WebP gratis reduce el tamano del archivo sin comprometer la calidad. Ideal para web, redes sociales, correo y almacenamiento. Comprime JPG, PNG y WebP con calidad ajustable de 10% a 100%.',
    aboutP2:
  ...
  pt: {
    ...
    schemaWebAppName: 'Compressor WebP - Ferramenta Gratis de Compressao',
    schemaWebAppDescription:
      'Compressor WebP gratis para reduzir o tamanho da imagem sem perder qualidade. Comprima JPG, PNG e WebP com controle de qualidade.',
    schemaFeatureList: [
    ...
    schemaHowToTool: 'Pixselli Compressor WebP',
    ...
    schemaFaq1A:
      'A compressao reduz o tamanho do arquivo removendo dados redundantes mantendo a qualidade visual. Nossa ferramenta otimiza JPG, PNG e WebP sem perda perceptivel.',
    ...
    breadcrumbHome: 'Inicio',
    breadcrumbTool: 'Compressor WebP',
    title: 'Compressor WebP',
    subtitle:
      'Comprima imagens sem perder qualidade. Reduza o tamanho de JPG, PNG e WebP com controle de qualidade. Rapido, seguro e tudo no navegador.',
    ...
    statsCompressed: 'Comprimida',
    statsSaved: 'Economia',
    aboutTitle: 'Sobre o Compressor WebP',
    aboutP1:
      'Nosso Compressor WebP gratis reduz o tamanho do arquivo sem comprometer a qualidade. Ideal para web, redes sociais, email e armazenamento. Comprima JPG, PNG e WebP com qualidade ajustavel de 10% a 100%.',
    aboutP2:
  ...
  fr: {
    ...
    schemaWebAppName: 'Compresseur WebP - Outil Gratuit de Compression',
    schemaWebAppDescription:
      'Compresseur WebP gratuit pour reduire la taille des images sans perdre de qualite. Compressez JPG, PNG et WebP avec un reglage de qualite.',
    schemaFeatureList: [
      'Compresser des images JPG',
    ...
    schemaHowToTool: 'Pixselli Compresseur WebP',
    ...
    schemaFaq1A:
      'La compression reduit la taille du fichier en supprimant des donnees redundantes tout en conservant la qualite visuelle. Notre outil optimise JPG, PNG et WebP sans perte visible.',
    ...
    breadcrumbTool: 'Compresseur WebP',
    title: 'Compresseur WebP',
    subtitle:
      'Compressez des images sans perdre de qualite. Reduisez la taille des JPG, PNG et WebP avec un reglage de qualite. Rapide, securise et 100% navigateur.',
    ...
    statsSaved: 'Economie',
    aboutTitle: 'A propos du Compresseur WebP',
    aboutP1:
      'Notre compresseur WebP gratuit reduit la taille des images sans compromettre la qualite. Ideal pour le web, les reseaux sociaux, les emails et le stockage. Compressez JPG, PNG et WebP avec un reglage de 10% a 100%.',
    aboutP2:
  ...
  de: {
    ...
    schemaWebAppName: 'WebP Kompressor - Kostenloses Online Tool',
    schemaWebAppDescription:
      'Kostenloser WebP Kompressor zum Reduzieren der Bilddateigrosse ohne sichtbaren Qualitatsverlust. Komprimiert JPG, PNG und WebP mit Qualitatsregler.',
    schemaFeatureList: [
    ...
    schemaHowToTool: 'Pixselli WebP Kompressor',
    ...
    schemaFaq1A:
      'Bildkomprimierung reduziert die Dateigrosse, indem redundante Daten entfernt werden, wahrend die visuelle Qualitat erhalten bleibt. Unser Tool optimiert JPG, PNG und WebP ohne sichtbaren Verlust.',
    ...
    breadcrumbTool: 'WebP Kompressor',
    title: 'WebP Kompressor',
    subtitle:
      'Bilder ohne sichtbaren Qualitatsverlust komprimieren. Dateigrosse von JPG, PNG und WebP reduzieren. Schnell, sicher und komplett im Browser.',
    ...
    aboutTitle: 'Uber den WebP Kompressor',
    aboutP1:
      'Unser kostenloser WebP Kompressor reduziert die Dateigrosse ohne die visuelle Qualitat stark zu beeintrachtigen. Ideal fur Websites, Social Media, E-Mails und Cloud. Komprimiert JPG, PNG und WebP von 10% bis 100%.',
    aboutP2:
  ...
  it: {
    ...
    schemaWebAppName: 'Compressore WebP - Strumento Online Gratis',
    schemaWebAppDescription:
      'Compressore WebP gratis per ridurre la dimensione delle immagini senza perdere qualita. Comprimi JPG, PNG e WebP con controllo qualita.',
    schemaFeatureList: [
      'Comprimi immagini JPG',
    ...
    schemaHowToTool: 'Pixselli Compressore WebP',
    ...
    schemaFaq1A:
      'La compressione riduce la dimensione del file rimuovendo dati ridondanti mantenendo la qualita visiva. Il nostro strumento ottimizza JPG, PNG e WebP senza perdita evidente.',
    ...
    breadcrumbHome: 'Home',
    breadcrumbTool: 'Compressore WebP',
    title: 'Compressore WebP',
    subtitle:
      'Comprimi immagini senza perdere qualita. Riduci la dimensione di JPG, PNG e WebP con qualita regolabile. Veloce, sicuro e tutto nel browser.',
    ...
    aboutTitle: 'Informazioni sul Compressore WebP',
    aboutP1:
      'Il nostro compressore WebP gratis riduce la dimensione del file senza compromettere la qualita. Ideale per web, social, email e cloud. Comprimi JPG, PNG e WebP con qualita da 10% a 100%.',
    aboutP2:
...
export default function Page() {
  ...
  const copy = WEBP_COMPRESSOR_COPY[locale as keyof typeof WEBP_COMPRESSOR_COPY] ?? WEBP_COMPRESSOR_COPY.en;
  const homeHref = locale === 'en' ? '/' : `/${locale}`;
  const toolPath = locale === 'en' ? '/webp-compressor' : `/${locale}/webp-compressor`;
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <div className="bg-white rounded-xl p-6 shadow-sm">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 id="step1" className="font-bold text-gray-900 mb-2">{copy.step1Title}</h3>
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 id="step2" className="font-bold text-gray-900 mb-2">{copy.step2Title}</h3>
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 id="step3" className="font-bold text-gray-900 mb-2">{copy.step3Title}</h3>
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 id="step4" className="font-bold text-gray-900 mb-2">{copy.step4Title}</h3>
