...
import { Upload, Download, RotateCcw, Image as ImageIcon, Mail, Shield, ChevronDown, AlertCircle } from 'lucide-react';
import { useLanguage } from '@/components/LanguageProvider';
import { translateReactNode } from '@/lib/translateReactNode';
import { COMPRESS_FOR_EMAIL_TEXT_BY_LOCALE } from '@/lib/compressForEmailTranslations';
...
export default function CompressForEmailPage() {
  ...
  const dict = COMPRESS_FOR_EMAIL_TEXT_BY_LOCALE[locale] ?? {};
  ...
  const processImageToTargetSize = useCallback(async (
    ...
    try {
      ...
      // Calculate Email-Ready dimensions
      let width = img.width;
  ...
  const downloadImage = async () => {
    ...
    if (outputVariants.length === 1) {
      ...
      link.download = `email_ready_image.${single.extension}`;
    ...
    outputVariants.forEach((variant) => {
      zip.file(`email_ready_${variant.label.toLowerCase()}.${variant.extension}`, variant.blob);
    });
    ...
    const link = document.createElement('a');
    link.href = zipUrl;
    link.download = 'email_ready_outputs.zip';
    document.body.appendChild(link);
    link.click();
    document.body.removeChild(link);
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "WebApplication",
            "name": "Compress for Email - Image Optimizer",
            "description": "Optimize images for fast email attachments with automatic resizing to 800x600 and 75% quality compression.",
        ...
        <main className="max-w-7xl mx-auto">
          ...
          <nav aria-label="Breadcrumb" className="mb-8">
            <ol className="flex items-center gap-2 text-sm text-gray-600" itemScope itemType="https://schema.org/BreadcrumbList">
              ...
              <li itemProp="itemListElement" itemScope itemType="https://schema.org/ListItem">
                <span itemProp="name" className="text-gray-900 font-medium">Compress for Email</span>
          ...
          <div className="bg-gradient-to-r from-purple-50 to-pink-50 border border-purple-200 rounded-xl p-6 mb-8 max-w-4xl mx-auto">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-gray-900 mb-2">Email-Ready Settings</h3>
            ...
            {!imageState.originalUrl ? (
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-2xl font-bold text-gray-800 mb-3">Upload Image to Optimize for Email</p>
              ...
              <div className="space-y-6">
                ...
                {imageState.compressedSize > 0 && (
                  <div className="grid grid-cols-3 gap-4">
                    ...
                    <div className="bg-gradient-to-br from-green-50 to-green-100 border-green-200 rounded-lg p-4 border text-center">
                      <p className="text-xs font-medium mb-1 text-green-600">Email-Ready</p>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="text-sm font-medium mb-1 text-green-900">
                          ✓ Email-Ready Successfully!
                        </p>
                        <p className="text-xs text-green-700">
                          Compressed to {formatFileSize(imageState.compressedSize)} with 75% quality. Perfect for fast email attachments while maintaining excellent visual quality.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="flex gap-3">
                  ...
                  >
                    ...
                    {outputVariants.length > 1 ? 'Download Email-Ready Outputs (ZIP)' : 'Download Email-Ready Image'}
                  </button>
                </div>
              </div>
            )}
          ...
          <section className="bg-white rounded-xl shadow-md p-8 border border-gray-200 mb-12 max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">About Compress for Email Tool</h2>
          ...
          <section className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12 max-w-4xl mx-auto">
            <div className="bg-white rounded-xl shadow-md p-6 text-center border border-gray-200 hover:border-purple-400 hover:shadow-lg transition-all">
              ...
              <h3 className="text-lg font-bold text-gray-900 mb-2">Email-Ready</h3>
              <p className="text-gray-600">Perfect balance for fast loading emails.</p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-md p-6 text-center border border-gray-200 hover:border-pink-400 hover:shadow-lg transition-all">
              ...
              <p className="text-gray-600">Auto-resize to 800×600 max dimensions.</p>
            </div>
          ...
          {/* How to Use Section */}
          <section className="bg-white rounded-xl shadow-md p-8 border border-gray-200 mb-12 max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">How to Optimize Images for Email</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Smart resize to 800×600 max and 75% quality compression.</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Check file size reduction and quality for your email needs.</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Download your Email-Ready image ready for your email.</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-6 p-4 bg-purple-50 border border-purple-200 rounded-lg">
              <p className="text-sm text-purple-800">
                <strong>Pro Tip:</strong> This tool is perfect for blog posts, product images, and general email content. The 75% quality provides excellent visuals while ensuring easy email sending.
              </p>
            </div>
          </section>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white rounded-xl shadow-md border border-gray-200 overflow-hidden">
                ...
                {openFaqIndex === 0 && (
                  <div className="px-6 pb-4 pt-2 text-gray-700 border-t border-gray-100">
                    <p>This tool is specifically optimized for web usage. It automatically resizes oversized images to email-friendly dimensions (max 800×600) and applies 75% quality compression - the sweet spot for balancing file size and visual quality on emails.</p>
                  </div>
                )}
              </div>
              ...
              <div className="bg-white rounded-xl shadow-md border border-gray-200 overflow-hidden">
                <button
                  ...
                  className="w-full px-6 py-4 text-left font-semibold text-gray-900 flex items-center justify-between hover:bg-purple-50 transition-colors"
                >
                  <span>Why 75% quality?</span>
                  <ChevronDown className={`w-5 h-5 text-gray-500 transition-transform ${openFaqIndex === 1 ? 'rotate-180' : ''}`} />
                </button>
                {openFaqIndex === 1 && (
                  <div className="px-6 pb-4 pt-2 text-gray-700 border-t border-gray-100">
                    <p>75% quality is considered the optimal balance for web images. It provides significant file size reduction while maintaining excellent visual quality that's virtually indistinguishable from the original to most users. This helps emails load faster without sacrificing appearance.</p>
                  </div>
                )}
              </div>
              ...
              <div className="bg-white rounded-xl shadow-md border border-gray-200 overflow-hidden">
                ...
                {openFaqIndex === 2 && (
                  <div className="px-6 pb-4 pt-2 text-gray-700 border-t border-gray-100">
                    <p>Only if necessary. Images larger than 800×600 pixels will be resized to fit within these dimensions while maintaining the original aspect ratio. Smaller images keep their original dimensions. This prevents unnecessarily large images from slowing down your email.</p>
                  </div>
                )}
              </div>
              ...
              <div className="bg-white rounded-xl shadow-md border border-gray-200 overflow-hidden">
                ...
                {openFaqIndex === 3 && (
                  <div className="px-6 pb-4 pt-2 text-gray-700 border-t border-gray-100">
                    <p>The optimized image is saved as a JPEG file, which is the most widely supported and efficient format for web use. JPEG provides excellent compression for photographs and complex images commonly used on emails.</p>
                  </div>
                )}
              </div>
