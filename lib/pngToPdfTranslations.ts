...
export const PNG_TO_PDF_TEXT_BY_LOCALE: Partial<Record<Locale, TranslationDict>> = {
  pt: {
    Home: 'Inicio',
    'PNG to PDF Converter': 'Conversor PNG para PDF',
    'Convert PNG images to PDF documents with advanced options including page size, orientation, margins, and multi-image merge.':
      'Converta imagens PNG em documentos PDF com opcoes avancadas de tamanho de pagina, orientacao, margens e uniao de varias imagens.',
    'Upload PNG Images': 'Enviar imagens PNG',
    ...
    Reset: 'Redefinir',
    'About PNG to PDF Converter': 'Sobre o conversor PNG para PDF',
    'This tool converts PNG files into PDF with layout controls for page size, orientation, margins, fit mode, and quality.':
      'Esta ferramenta converte arquivos PNG em PDF com controles de layout para tamanho de pagina, orientacao, margens, modo de ajuste e qualidade.',
    Features: 'Recursos',
    ...
    'Can I convert multiple PNG files into one PDF?':
      'Posso converter varios arquivos PNG em um unico PDF?',
    ...
    'Please select valid PNG files': 'Selecione arquivos PNG validos',
  ...
  fr: {
    Home: 'Accueil',
    'PNG to PDF Converter': 'Convertisseur PNG vers PDF',
    'Convert PNG images to PDF documents with advanced options including page size, orientation, margins, and multi-image merge.':
      'Convertissez des images PNG en documents PDF avec des options avancees (taille de page, orientation, marges et fusion de plusieurs images).',
    'Upload PNG Images': 'Televerser des images PNG',
    'Drag and drop or click to browse. Multiple files supported.':
    ...
    Reset: 'Reinitialiser',
    'About PNG to PDF Converter': 'A propos du convertisseur PNG vers PDF',
    'This tool converts PNG files into PDF with layout controls for page size, orientation, margins, fit mode, and quality.':
      'Cet outil convertit des fichiers PNG en PDF avec des controles de mise en page (taille, orientation, marges, ajustement et qualite).',
    ...
    'Please select valid PNG files':
      'Veuillez selectionner des fichiers PNG valides',
    'Failed to read one or more images.':
  ...
  de: {
    Home: 'Startseite',
    'PNG to PDF Converter': 'PNG-zu-PDF-Konverter',
    'Convert PNG images to PDF documents with advanced options including page size, orientation, margins, and multi-image merge.':
      'Konvertiere PNG-Bilder in PDF-Dokumente mit erweiterten Optionen wie Seitengrosse, Ausrichtung, Randern und Zusammenfuhren mehrerer Bilder.',
    'Upload PNG Images': 'PNG-Bilder hochladen',
    'Drag and drop or click to browse. Multiple files supported.':
    ...
    Reset: 'Zurucksetzen',
    'About PNG to PDF Converter': 'Uber den PNG-zu-PDF-Konverter',
    'This tool converts PNG files into PDF with layout controls for page size, orientation, margins, fit mode, and quality.':
      'Dieses Tool konvertiert PNG-Dateien in PDF mit Layout-Einstellungen fur Seitengrosse, Ausrichtung, Rander, Anpassung und Qualitat.',
    Features: 'Funktionen',
    ...
    'Can I convert multiple PNG files into one PDF?':
      'Kann ich mehrere PNG-Dateien in ein PDF umwandeln?',
    'Yes. Keep merge enabled and all selected images will be added as PDF pages.':
    ...
    'Please select valid PNG files':
      'Bitte wahlen Sie gultige PNG-Dateien aus',
    'Failed to read one or more images.':
  ...
  it: {
    Home: 'Home',
    'PNG to PDF Converter': 'Convertitore PNG in PDF',
    'Convert PNG images to PDF documents with advanced options including page size, orientation, margins, and multi-image merge.':
      'Converti immagini PNG in documenti PDF con opzioni avanzate (dimensione pagina, orientamento, margini e unione di piu immagini).',
    'Upload PNG Images': 'Carica immagini PNG',
    'Drag and drop or click to browse. Multiple files supported.':
    ...
    Reset: 'Reimposta',
    'About PNG to PDF Converter': 'Informazioni sul convertitore PNG in PDF',
    'This tool converts PNG files into PDF with layout controls for page size, orientation, margins, fit mode, and quality.':
      'Questo strumento converte file PNG in PDF con controlli per dimensione pagina, orientamento, margini, adattamento e qualita.',
    ...
    'Can I convert multiple PNG files into one PDF?':
      'Posso convertire piu file PNG in un unico PDF?',
    'Yes. Keep merge enabled and all selected images will be added as PDF pages.':
