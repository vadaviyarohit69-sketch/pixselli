...
export const AVIF_TO_PDF_TEXT_BY_LOCALE: Partial<Record<Locale, TranslationDict>> = {
  pt: {
    Home: 'Inicio',
    'AVIF to PDF Converter': 'Conversor AVIF para PDF',
    'Convert AVIF images to PDF documents with advanced options including page size, orientation, margins, and multi-image merge.':
      'Converta imagens AVIF em documentos PDF com opcoes avancadas de tamanho de pagina, orientacao, margens e uniao de varias imagens.',
    'Upload AVIF Images': 'Enviar imagens AVIF',
    ...
    Reset: 'Redefinir',
    'About AVIF to PDF Converter': 'Sobre o conversor AVIF para PDF',
    'This tool converts AVIF files into PDF with layout controls for page size, orientation, margins, fit mode, and quality.':
      'Esta ferramenta converte arquivos AVIF em PDF com controles de layout para tamanho de pagina, orientacao, margens, modo de ajuste e qualidade.',
    Features: 'Recursos',
    ...
    'Can I convert multiple AVIF files into one PDF?':
      'Posso converter varios arquivos AVIF em um unico PDF?',
    ...
    'Please select valid AVIF files': 'Selecione arquivos AVIF validos',
  ...
  fr: {
    Home: 'Accueil',
    'AVIF to PDF Converter': 'Convertisseur AVIF vers PDF',
    'Convert AVIF images to PDF documents with advanced options including page size, orientation, margins, and multi-image merge.':
      'Convertissez des images AVIF en documents PDF avec des options avancees (taille de page, orientation, marges et fusion de plusieurs images).',
    'Upload AVIF Images': 'Televerser des images AVIF',
    'Drag and drop or click to browse. Multiple files supported.':
    ...
    Reset: 'Reinitialiser',
    'About AVIF to PDF Converter': 'A propos du convertisseur AVIF vers PDF',
    'This tool converts AVIF files into PDF with layout controls for page size, orientation, margins, fit mode, and quality.':
      'Cet outil convertit des fichiers AVIF en PDF avec des controles de mise en page (taille, orientation, marges, ajustement et qualite).',
    ...
    'Can I convert multiple AVIF files into one PDF?':
      'Puis-je convertir plusieurs fichiers AVIF en un seul PDF ?',
    'Yes. Keep merge enabled and all selected images will be added as PDF pages.':
    ...
    'Please select valid AVIF files':
      'Veuillez selectionner des fichiers AVIF valides',
    'Failed to read one or more images.':
  ...
  de: {
    Home: 'Startseite',
    'AVIF to PDF Converter': 'AVIF-zu-PDF-Konverter',
    'Convert AVIF images to PDF documents with advanced options including page size, orientation, margins, and multi-image merge.':
      'Konvertiere AVIF-Bilder in PDF-Dokumente mit erweiterten Optionen wie Seitengrosse, Ausrichtung, Randern und Zusammenfuhren mehrerer Bilder.',
    'Upload AVIF Images': 'AVIF-Bilder hochladen',
    'Drag and drop or click to browse. Multiple files supported.':
    ...
    Reset: 'Zurucksetzen',
    'About AVIF to PDF Converter': 'Uber den AVIF-zu-PDF-Konverter',
    'This tool converts AVIF files into PDF with layout controls for page size, orientation, margins, fit mode, and quality.':
      'Dieses Tool konvertiert AVIF-Dateien in PDF mit Layout-Einstellungen fur Seitengrosse, Ausrichtung, Rander, Anpassung und Qualitat.',
    Features: 'Funktionen',
    ...
    'Can I convert multiple AVIF files into one PDF?':
      'Kann ich mehrere AVIF-Dateien in ein PDF umwandeln?',
    'Yes. Keep merge enabled and all selected images will be added as PDF pages.':
    ...
    'Please select valid AVIF files':
      'Bitte wahlen Sie gultige AVIF-Dateien aus',
    'Failed to read one or more images.':
  ...
  it: {
    Home: 'Home',
    'AVIF to PDF Converter': 'Convertitore AVIF in PDF',
    'Convert AVIF images to PDF documents with advanced options including page size, orientation, margins, and multi-image merge.':
      'Converti immagini AVIF in documenti PDF con opzioni avanzate (dimensione pagina, orientamento, margini e unione di piu immagini).',
    'Upload AVIF Images': 'Carica immagini AVIF',
    'Drag and drop or click to browse. Multiple files supported.':
    ...
    Reset: 'Reimposta',
    'About AVIF to PDF Converter': 'Informazioni sul convertitore AVIF in PDF',
    'This tool converts AVIF files into PDF with layout controls for page size, orientation, margins, fit mode, and quality.':
      'Questo strumento converte file AVIF in PDF con controlli per dimensione pagina, orientamento, margini, adattamento e qualita.',
    ...
    'Can I convert multiple AVIF files into one PDF?':
      'Posso convertire piu file AVIF in un unico PDF?',
    'Yes. Keep merge enabled and all selected images will be added as PDF pages.':
