...
export const WEBP_TO_PDF_TEXT_BY_LOCALE: Partial<Record<Locale, TranslationDict>> = {
  pt: {
    Home: 'Inicio',
    'WEBP to PDF Converter': 'Conversor WebP para PDF',
    'Convert WEBP images to PDF documents with advanced options including page size, orientation, margins, and multi-image merge.':
      'Converta imagens WebP em documentos PDF com opcoes avancadas de tamanho de pagina, orientacao, margens e uniao de varias imagens.',
    'Upload WEBP Images': 'Enviar imagens WebP',
    ...
    Reset: 'Redefinir',
    'About WEBP to PDF Converter': 'Sobre o conversor WebP para PDF',
    'This tool converts WEBP files into PDF with layout controls for page size, orientation, margins, fit mode, and quality.':
      'Esta ferramenta converte arquivos WebP em PDF com controles de layout para tamanho de pagina, orientacao, margens, modo de ajuste e qualidade.',
    Features: 'Recursos',
    ...
    'Can I convert multiple WEBP files into one PDF?':
      'Posso converter varios arquivos WebP em um unico PDF?',
    ...
    'Please select valid WEBP files': 'Selecione arquivos WebP validos',
  ...
  fr: {
    Home: 'Accueil',
    'WEBP to PDF Converter': 'Convertisseur WebP vers PDF',
    'Convert WEBP images to PDF documents with advanced options including page size, orientation, margins, and multi-image merge.':
      'Convertissez des images WebP en documents PDF avec des options avancees (taille de page, orientation, marges et fusion de plusieurs images).',
    'Upload WEBP Images': 'Televerser des images WebP',
    'Drag and drop or click to browse. Multiple files supported.':
    ...
    Reset: 'Reinitialiser',
    'About WEBP to PDF Converter': 'A propos du convertisseur WebP vers PDF',
    'This tool converts WEBP files into PDF with layout controls for page size, orientation, margins, fit mode, and quality.':
      'Cet outil convertit des fichiers WebP en PDF avec des controles de mise en page (taille, orientation, marges, ajustement et qualite).',
    ...
    'Can I convert multiple WEBP files into one PDF?':
      'Puis-je convertir plusieurs fichiers WebP en un seul PDF ?',
    'Yes. Keep merge enabled and all selected images will be added as PDF pages.':
    ...
    'Please select valid WEBP files':
      'Veuillez selectionner des fichiers WebP valides',
    'Failed to read one or more images.':
  ...
  de: {
    Home: 'Startseite',
    'WEBP to PDF Converter': 'WebP-zu-PDF-Konverter',
    'Convert WEBP images to PDF documents with advanced options including page size, orientation, margins, and multi-image merge.':
      'Konvertiere WebP-Bilder in PDF-Dokumente mit erweiterten Optionen wie Seitengrosse, Ausrichtung, Randern und Zusammenfuhren mehrerer Bilder.',
    'Upload WEBP Images': 'WebP-Bilder hochladen',
    'Drag and drop or click to browse. Multiple files supported.':
    ...
    Reset: 'Zurucksetzen',
    'About WEBP to PDF Converter': 'Uber den WebP-zu-PDF-Konverter',
    'This tool converts WEBP files into PDF with layout controls for page size, orientation, margins, fit mode, and quality.':
      'Dieses Tool konvertiert WebP-Dateien in PDF mit Layout-Einstellungen fur Seitengrosse, Ausrichtung, Rander, Anpassung und Qualitat.',
    Features: 'Funktionen',
    ...
    'Can I convert multiple WEBP files into one PDF?':
      'Kann ich mehrere WebP-Dateien in ein PDF umwandeln?',
    'Yes. Keep merge enabled and all selected images will be added as PDF pages.':
    ...
    'Please select valid WEBP files':
      'Bitte wahlen Sie gultige WebP-Dateien aus',
    'Failed to read one or more images.':
  ...
  it: {
    Home: 'Home',
    'WEBP to PDF Converter': 'Convertitore WebP in PDF',
    'Convert WEBP images to PDF documents with advanced options including page size, orientation, margins, and multi-image merge.':
      'Converti immagini WebP in documenti PDF con opzioni avanzate (dimensione pagina, orientamento, margini e unione di piu immagini).',
    'Upload WEBP Images': 'Carica immagini WebP',
    'Drag and drop or click to browse. Multiple files supported.':
    ...
    Reset: 'Reimposta',
    'About WEBP to PDF Converter': 'Informazioni sul convertitore WebP in PDF',
    'This tool converts WEBP files into PDF with layout controls for page size, orientation, margins, fit mode, and quality.':
      'Questo strumento converte file WebP in PDF con controlli per dimensione pagina, orientamento, margini, adattamento e qualita.',
    ...
    'Can I convert multiple WEBP files into one PDF?':
      'Posso convertire piu file WebP in un unico PDF?',
    'Yes. Keep merge enabled and all selected images will be added as PDF pages.':
