...
export const HEIC_TO_PDF_TEXT_BY_LOCALE: Partial<Record<Locale, TranslationDict>> = {
  pt: {
    Home: 'Inicio',
    'HEIC to PDF Converter': 'Conversor HEIC para PDF',
    'Convert HEIC images to PDF documents with advanced options including page size, orientation, margins, and multi-image merge.':
      'Converta imagens HEIC em documentos PDF com opcoes avancadas de tamanho de pagina, orientacao, margens e uniao de varias imagens.',
    'Upload HEIC Images': 'Enviar imagens HEIC',
    ...
    Reset: 'Redefinir',
    'About HEIC to PDF Converter': 'Sobre o conversor HEIC para PDF',
    'This tool converts HEIC files into PDF with layout controls for page size, orientation, margins, fit mode, and quality.':
      'Esta ferramenta converte arquivos HEIC em PDF com controles de layout para tamanho de pagina, orientacao, margens, modo de ajuste e qualidade.',
    Features: 'Recursos',
    ...
    'Can I convert multiple HEIC files into one PDF?':
      'Posso converter varios arquivos HEIC em um unico PDF?',
    ...
    'Please select valid HEIC files': 'Selecione arquivos HEIC validos',
  ...
  fr: {
    Home: 'Accueil',
    'HEIC to PDF Converter': 'Convertisseur HEIC vers PDF',
    'Convert HEIC images to PDF documents with advanced options including page size, orientation, margins, and multi-image merge.':
      'Convertissez des images HEIC en documents PDF avec des options avancees (taille de page, orientation, marges et fusion de plusieurs images).',
    'Upload HEIC Images': 'Televerser des images HEIC',
    'Drag and drop or click to browse. Multiple files supported.':
    ...
    Reset: 'Reinitialiser',
    'About HEIC to PDF Converter': 'A propos du convertisseur HEIC vers PDF',
    'This tool converts HEIC files into PDF with layout controls for page size, orientation, margins, fit mode, and quality.':
      'Cet outil convertit des fichiers HEIC en PDF avec des controles de mise en page (taille, orientation, marges, ajustement et qualite).',
    ...
    'Can I convert multiple HEIC files into one PDF?':
      'Puis-je convertir plusieurs fichiers HEIC en un seul PDF ?',
    'Yes. Keep merge enabled and all selected images will be added as PDF pages.':
    ...
    'Please select valid HEIC files':
      'Veuillez selectionner des fichiers HEIC valides',
    'Failed to read one or more images.':
  ...
  de: {
    Home: 'Startseite',
    'HEIC to PDF Converter': 'HEIC-zu-PDF-Konverter',
    'Convert HEIC images to PDF documents with advanced options including page size, orientation, margins, and multi-image merge.':
      'Konvertiere HEIC-Bilder in PDF-Dokumente mit erweiterten Optionen wie Seitengrosse, Ausrichtung, Randern und Zusammenfuhren mehrerer Bilder.',
    'Upload HEIC Images': 'HEIC-Bilder hochladen',
    'Drag and drop or click to browse. Multiple files supported.':
    ...
    Reset: 'Zurucksetzen',
    'About HEIC to PDF Converter': 'Uber den HEIC-zu-PDF-Konverter',
    'This tool converts HEIC files into PDF with layout controls for page size, orientation, margins, fit mode, and quality.':
      'Dieses Tool konvertiert HEIC-Dateien in PDF mit Layout-Einstellungen fur Seitengrosse, Ausrichtung, Rander, Anpassung und Qualitat.',
    Features: 'Funktionen',
    ...
    'Can I convert multiple HEIC files into one PDF?':
      'Kann ich mehrere HEIC-Dateien in ein PDF umwandeln?',
    'Yes. Keep merge enabled and all selected images will be added as PDF pages.':
    ...
    'Please select valid HEIC files':
      'Bitte wahlen Sie gultige HEIC-Dateien aus',
    'Failed to read one or more images.':
  ...
  it: {
    Home: 'Home',
    'HEIC to PDF Converter': 'Convertitore HEIC in PDF',
    'Convert HEIC images to PDF documents with advanced options including page size, orientation, margins, and multi-image merge.':
      'Converti immagini HEIC in documenti PDF con opzioni avanzate (dimensione pagina, orientamento, margini e unione di piu immagini).',
    'Upload HEIC Images': 'Carica immagini HEIC',
    'Drag and drop or click to browse. Multiple files supported.':
    ...
    Reset: 'Reimposta',
    'About HEIC to PDF Converter': 'Informazioni sul convertitore HEIC in PDF',
    'This tool converts HEIC files into PDF with layout controls for page size, orientation, margins, fit mode, and quality.':
      'Questo strumento converte file HEIC in PDF con controlli per dimensione pagina, orientamento, margini, adattamento e qualita.',
    ...
    'Can I convert multiple HEIC files into one PDF?':
      'Posso convertire piu file HEIC in un unico PDF?',
    'Yes. Keep merge enabled and all selected images will be added as PDF pages.':
